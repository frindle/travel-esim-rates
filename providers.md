...
| **Jetpac** | Per-GB capped + regional/global bundles + some unlimited (FUP) | Top-up on many plans; refund varies | ⚠️ varies by plan — check first | Instant QR (iOS+Android), no ID | Growing (Singapore) | Free key-app access when data runs out; some regional coverage gaps |

...
TARGET = pathlib.Path('build.py')

# frozen from TASK.md -- re-run `ollama-dispatch-scaffold --freeze-literals .`
LITERALS = [[None, '_rank_rows(rows, rank_by="pergb", min_gb=None, top_n=3, hotspot_only=False, include_unlimited=False)'], [None, 'def global_rows(data):'], [None, 'const GLOBAL_ROWS='], [None, 'Worldwide / Global'], [None, 'id="globalTb"'], [None, 'renderGlobal()']]

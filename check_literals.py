...
LITERALS = [[None, 'def parse_global(md_path):'], [None, 'row["global_coverage"] = True'], [None, '"Worldwide / Global"'], [None, '<span class="chip">Global</span>'], [None, 'GLOBAL_ROWS'], [None, 'def render_country_page(entry, global_rows=()):']]
